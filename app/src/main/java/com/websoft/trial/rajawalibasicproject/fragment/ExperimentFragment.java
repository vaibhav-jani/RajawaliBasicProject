 ...
 */
public class ExperimentFragment extends Fragment implements IRajawaliDisplay {
    ...
    public static ExperimentFragment getInstance() {

        ExperimentFragment earthFragment = new ExperimentFragment();
    ...
    public IRajawaliSurfaceRenderer createRenderer() {
        ...
        //return new ExperimentObjectRenderer(getActivity());
